...
const index = (props: Props) => {
  ...
  return (
    ...
    <View style={tw`flex flex-row gap-8 my-4 items-center`}>
      ...
      <Switch style={tw`bg-white-400 `}   value={groupWatchChecked} onChange={()=>setGroupWatchChecked(!groupWatchChecked)} />
    </View>
    <View style={tw`flex flex-row gap-8 my-4 items-center`}>
        <View style={tw`flex  gap-4`}>
      ...
      <Switch style={tw`bg-white-400 `}   value={kidWatchedChecked} onChange={()=>setkidWatchedChecked(!groupWatchChecked)} />
    </View>
    <Button title='Create Pin'  style={tw`mt-4`} onPress={()=>console.log('')}/>
